...
InterruptManager::GateDecriptor InterruptManager::interruptDescriptorTable[256];
    ...
    uint8_t DescriptorType)
{
    ...
    interruptDescriptorTable[interruptNumber].gdt_codeSegement = codeSegmentSelectorOffset;
...
picSlaveData(0xA1)
{
    ...
    idt.size=256*sizeof(GateDecriptor)-1;
